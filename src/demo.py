...
TTO = Namespace("https://materialdigital.github.io/application-ontologies/tto/#/")#TTO is the ontology
g.bind("tto", TTO)  #Base
...
g.add((thicknessIRI_scalar_value, PMD.PMD_0000006, Literal(thickness, datatype=XSD.float)))# has value
g.add((thicknessIRI_scalar_value, PMD.PMD_0060001, thicknessIRI_quality))# specifies thickness value
