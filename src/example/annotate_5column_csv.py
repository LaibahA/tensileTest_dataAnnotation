...
with open("../../data/example/example_5column.csv") as f:
...
g.serialize("../output/example/5column/csv_input_turtle_output.ttl", format="turtle")
g.serialize("../output/example/5column/csv_input_jsonld_output.jsonld", format="json-ld")
