...
with open("../../data/example/example_3column.csv") as f:
...
g.serialize("../output/example/3column/csv_input_turtle_output.ttl", format="turtle")
g.serialize("../output/example/3column/csv_input_jsonld_output.jsonld", format="json-ld")
